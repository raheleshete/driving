...
add_filter( 'pt-ocdi/import_files', function() {
    return array(
        array(
            'import_file_name'             => esc_html__('Driving School', 'chaoz'),
            ...
            'preview_url'                  => 'https://smartdata.tonytemplates.com/dricub-driving-school/',
            'local_import_redux'           => array(
                array(
                    'file_path'   =>  plugin_dir_path( __FILE__ ). 'demo-data/demo1/settings.json',
                    'option_name' => 'dricub_driving_school_options',
                ),
            ),
		),
    );
