...
class sidebar_generator {
	...
	public static function admin_page(){
		...
		<div class="wrap">
			<h2><?php esc_html_e('Sidebar Generator', 'dricub-driving-school-core'); ?></h2>
			<p><?php esc_html_e('The sidebar name is for your use only. It will not be visible to any of your visitors. A CSS class is assigned to each of your sidebar, use this styling to customize the sidebars.', 'dricub-driving-school-core'); ?></p>
			<br />
			<div class="add_sidebar">
				<a href="javascript:void(0);" onclick="return add_sidebar_link()" title="Add a sidebar"><?php esc_html_e('+ Add Sidebar', 'dricub-driving-school-core') ?></a>
			</div>
			<br />
			<table class="widefat page" id="sbg_table" style="width:600px;">
				<tr>
					<th><?php esc_html_e('Name', 'dricub-driving-school-core'); ?></th>
					<th><?php esc_html_e('CSS class', 'dricub-driving-school-core'); ?></th>
					<th><?php esc_html_e('Remove', 'dricub-driving-school-core'); ?></th>
				</tr>
				<?php
				$sidebars = sidebar_generator::get_sidebars();
				...
				<tr class="<?php print esc_attr($alt) ?>">
					...
					<td><a href="javascript:void(0);" onclick="return remove_sidebar_link('<?php print esc_js($sidebar); ?>',<?php print esc_js($cnt+1); ?>);" title="<?php esc_attr_e('Remove this sidebar', 'dricub-driving-school-core')?>"><?php esc_html_e('remove', 'dricub-driving-school-core'); ?></a></td>
				</tr>
				<?php
						$cnt++;
					}
					...
					?>
					<tr>
						<td colspan="3"><?php esc_html_e('No Sidebars defined', 'dricub-driving-school-core'); ?></td>
					</tr>
					<?php
				}
				?>
